define([
    "require",
    "../../../../../../../../lab-maintainer/public/js/lib/dijit/_Widget",
    "../../../../../../../sugarcms/public/js/library/dijit/_Contained",
    "dijit/_Container",
    "dojo/_base/declare",
    "dojo/_base/lang",
    "dojo/_base/array",
            ...
            try {
                ...
                array.forEach(loadedPackages, lang.hitch(this, function (packageRequire) {
                    try {
                        ...
                        require(["dojo/text!" + packageRequire + "/backend.json"],
                            lang.hitch(this, function (resource) {
                                ...
                                pack.package = packageRequire + '/' + (pack.main || 'backend');
